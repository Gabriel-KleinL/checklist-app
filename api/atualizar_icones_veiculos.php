<?php
/**
 * Script para atualizar os ícones dos tipos de veículos
 * Execute via navegador: https://floripa.in9automacao.com.br/atualizar_icones_veiculos.php
 */
...
try {
    ...
    foreach ($atualizacoes as $atualizacao) {
        $sql = "UPDATE `checklist_tipos_veiculo` SET `icone` = :icone WHERE `id` = :id";
