...
try {
    ...
    if ($method === 'POST') {
        ...
        if (!$dados || !isset($dados['inspecao_id']) || !isset($dados['usuario_id'])) {
            http_response_code(400);
            echo json_encode(['erro' => 'Dados incompletos. É necessário informar: inspecao_id, usuario_id']);
            exit;
        }
        ...
        $sql = "UPDATE bbb_tempo_telas
                ...
                WHERE usuario_id = :usuario_id
                  ...
                  AND data_criacao >= DATE_SUB(NOW(), INTERVAL 30 MINUTE)";
