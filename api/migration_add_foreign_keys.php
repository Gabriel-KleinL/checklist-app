...
try {
    ...
    $foreignKeys = [
        ...
        [
            ...
            'sql' => 'ALTER TABLE `checklist_inspecao_item` 
                      ADD CONSTRAINT `fk_item_inspecao` 
                      FOREIGN KEY (`inspecao_id`) 
                      REFERENCES `checklist_inspecao_veiculo`(`id`) 
                      ON DELETE CASCADE'
        ],
        ...
        [
            ...
            'sql' => 'ALTER TABLE `checklist_inspecao_foto` 
        ...
        [
            ...
            'sql' => 'ALTER TABLE `checklist_tempo_telas` 
