...
try {
    ...
    $indices = [
        ...
        [
            'tabela' => 'checklist_inspecao_item',
            'nome' => 'idx_inspecao_item_inspecao_id',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_item_inspecao_id` ON `checklist_inspecao_item`(`inspecao_id`)'
        ],
        [
            'tabela' => 'checklist_inspecao_item',
            'nome' => 'idx_item_categoria',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_item_categoria` ON `checklist_inspecao_item`(`categoria`)'
        ],
        
        // checklist_inspecao_foto
        [
            'tabela' => 'checklist_inspecao_foto',
            'nome' => 'idx_inspecao_foto_inspecao_id',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_foto_inspecao_id` ON `checklist_inspecao_foto`(`inspecao_id`)'
        ],
        [
            'tabela' => 'checklist_inspecao_foto',
            'nome' => 'idx_foto_tipo',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_foto_tipo` ON `checklist_inspecao_foto`(`tipo`)'
        ],
        
        // checklist_inspecao_veiculo
        [
            'tabela' => 'checklist_inspecao_veiculo',
            'nome' => 'idx_inspecao_placa',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_placa` ON `checklist_inspecao_veiculo`(`placa`)'
        ],
        [
            'tabela' => 'checklist_inspecao_veiculo',
            'nome' => 'idx_inspecao_data',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_data` ON `checklist_inspecao_veiculo`(`data_realizacao`)'
        ],
        [
            'tabela' => 'checklist_inspecao_veiculo',
            'nome' => 'idx_inspecao_usuario',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_usuario` ON `checklist_inspecao_veiculo`(`usuario_id`)'
        ],
        [
            'tabela' => 'checklist_inspecao_veiculo',
            'nome' => 'idx_inspecao_tipo_veiculo',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_tipo_veiculo` ON `checklist_inspecao_veiculo`(`tipo_veiculo_id`)'
        ],
        [
            'tabela' => 'checklist_inspecao_veiculo',
            'nome' => 'idx_inspecao_usuario_data',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_inspecao_usuario_data` ON `checklist_inspecao_veiculo`(`usuario_id`, `data_realizacao`)'
        ],
        
        // checklist_anomalia_status
        [
            'tabela' => 'checklist_anomalia_status',
            'nome' => 'idx_anomalia_placa',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_anomalia_placa` ON `checklist_anomalia_status`(`placa`)'
        ],
        [
            'tabela' => 'checklist_anomalia_status',
            'nome' => 'idx_anomalia_status',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_anomalia_status` ON `checklist_anomalia_status`(`status_anomalia`)'
        ],
        [
            'tabela' => 'checklist_anomalia_status',
            'nome' => 'idx_anomalia_categoria_item',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_anomalia_categoria_item` ON `checklist_anomalia_status`(`categoria`, `item`)'
        ],
        
        // checklist_tempo_telas
        [
            'tabela' => 'checklist_tempo_telas',
            'nome' => 'idx_tempo_inspecao',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_tempo_inspecao` ON `checklist_tempo_telas`(`inspecao_id`)'
        ],
        [
            'tabela' => 'checklist_tempo_telas',
            'nome' => 'idx_tempo_tela',
            'sql' => 'CREATE INDEX IF NOT EXISTS `idx_tempo_tela` ON `checklist_tempo_telas`(`tela`)'
        ],
    ];
