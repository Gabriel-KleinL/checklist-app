<?php
/**
 * Script de Migração de Fotos Base64 -> Filesystem
 *
 ...
 *
 * USO:
 * - Via browser: http://localhost/api/b_foto_migrar.php
 * - Via CLI: php b_foto_migrar.php
 *
 * PARÂMETROS:
...
require_once __DIR__ . '/b_veicular_config.php';
require_once __DIR__ . '/utils/FotoUtils.php';
...
echo "========================================\n";
echo "MIGRAÇÃO DE FOTOS BASE64 → FILESYSTEM\n";
echo "========================================\n";
