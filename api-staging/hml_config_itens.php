...
// Carrega configuração centralizada (detecta staging automaticamente)
...
function buscarItensPorTipoVeiculo($pdo, $tipo_veiculo_id, $condicoes_adicionais = '', $params_adicionais = []) {
    ...
    $sql = "SELECT DISTINCT ci.* 
            FROM bbb_config_itens ci
            LEFT JOIN bbb_config_itens_tipos_veiculo citv ON ci.id = citv.config_item_id
    ...
    // ============================================
        ...
        switch ($acao) {
            ...
            case 'adicionar_item':
                ...
                try {
                    $sql = "INSERT INTO bbb_config_itens (tipo_checklist, categoria, nome_item, habilitado, tipo_veiculo_id, usuario_id)
                    ...
                    if (!$tipo_veiculo_id && isset($dados['tipos_veiculo_associados']) && is_array($dados['tipos_veiculo_associados']) && count($dados['tipos_veiculo_associados']) > 0) {
                        $sqlAssociar = "INSERT INTO bbb_config_itens_tipos_veiculo (config_item_id, tipo_veiculo_id) VALUES (:config_item_id, :tipo_veiculo_id)";
            ...
            case 'associar_geral':
                ...
                $sqlCheck = "SELECT id, tipo_veiculo_id FROM bbb_config_itens WHERE id = :id LIMIT 1";
                ...
                try {
                    ...
                    $sqlDelete = "DELETE FROM bbb_config_itens_tipos_veiculo WHERE config_item_id = :item_id";
                    $stmtDelete = $pdo->prepare($sqlDelete);
                    $stmtDelete->execute(['item_id' => $dados['item_id']]);

                    // Criar novas associações
                    $sqlInsert = "INSERT INTO bbb_config_itens_tipos_veiculo (config_item_id, tipo_veiculo_id) VALUES (:config_item_id, :tipo_veiculo_id)";
            ...
            case 'desassociar_geral':
                ...
                $sql = "DELETE FROM bbb_config_itens_tipos_veiculo 
